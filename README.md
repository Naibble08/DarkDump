...
## About Darkdump
DarkDump - это простой сценарий, записанный в Python3.9, в котором он позволяет пользователям вводить поисковый термин (запрос) в командной строке, а DarkDump вытащит все глубокие веб -сайты, относящиеся к этому запросу.Darkdump завершает API Darksearch.io.
## Installation
